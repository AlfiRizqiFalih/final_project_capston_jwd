...
<html lang="en">
  <head>
    ...
    <link 
      rel="shortcut icon"
      href="images/logo_malino_kuning.png"
      type="image/x-icon"
    />         
  </head>
  <body>
    <div class="main-container">
      <div class="img-header">
        <div class="brand-container">
          ...
          <h2>Di Sekitar Makassar Sulawesi Selatan</h2>
      ...
      <div class="menu-header">
        ...
        <a href="form_pendaftaran.php">Daftar Paket Wisata</a>
        <a href="list_pemesanan.php">Modifikasi Pesanan</a>
      </div>
