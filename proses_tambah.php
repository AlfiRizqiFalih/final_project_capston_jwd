<?php 
  if($_POST){ 
    ...
    if(isset($_POST['layanan_makan']) ){ 
     ...
     $sql = "INSERT INTO daftar_pesanan(id_paket_wisata, 
      nama_pemesan, no_tlp, tanggal_pemesanan, jumlah_peserta, 
      jumlah_hari, akomodasi, transportasi, makanan, 
      harga_paket, total_tagihan) VALUES('$id_paket_wisata', 
      '$nama_pemesan', '$no_tlp', '$tgl_pesan', 
      '$jumlah_peserta', '$jumlah_hari', 
      '$layanan_penginapan', '$layanan_transportasi', 
      '$layanan_makan', '$harga_paket', '$jumlah_tagihan')";
